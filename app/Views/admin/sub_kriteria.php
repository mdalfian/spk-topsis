                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="bottom"
                                    title="Delete" onclick="hapus_sub_kriteria(<?= $sk->id_sub_kriteria ?>)"><i
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form
                                                action="<?= base_url('Admin/sub_kriteria/edit/' . $sk->id_sub_kriteria . '') ?>"
                                                method="post">
                                                <div class="row">
    ...
    <div class="modal fade" id="addModal<?= $kri->id_kriteria ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('Admin/sub_kriteria/add/' . $kri->id_kriteria . '') ?>" method="post">
                        <div class="row">
                            <div class="control-group mb-3 col">
                                <label class="control-label" for="nama_sub_kriteria">Nama Sub
                                    Kriteria</label>
